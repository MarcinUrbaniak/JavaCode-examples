...
public class BootStrap {
    ...
    public static void generateData(){
        ...
        Income income5 = new Income(LocalDateTime.parse("2019-03-07T16:00:00"), IncomeCategory.INNE, Householder.ANNA, 3000.00);
        ...
        Expense expense4 = new Expense(LocalDateTime.parse("2019-05-02T12:00:00"), ExpenseCategory.OSOBISTE, Householder.ANNA, 670);
        Expense expense5 = new Expense(LocalDateTime.parse("2019-05-02T12:00:00"), ExpenseCategory.AUTO, Householder.ANNA, 600);
